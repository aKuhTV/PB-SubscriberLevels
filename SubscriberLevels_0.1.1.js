 ...
 */
 ...
 (function() {
    ...
    $.bind('initReady', function() {
        if ($.bot.isModuleEnabled('./custom/SubscriberLevels_0.1.1.js')) {
            $.registerChatCommand('./custom/SubscriberLevels_0.1.1.js', 'level', 7);
			$.registerChatCommand('./custom/SubscriberLevels_0.1.1.js', 'setlevelname', 1);
			$.registerChatCommand('./custom/SubscriberLevels_0.1.1.js', 'levelname', 1);
			$.registerChatCommand('./custom/SubscriberLevels_0.1.1.js', 'setsubemote', 1);
			$.registerChatCommand('./custom/SubscriberLevels_0.1.1.js', 'setsademote', 1);
			$.registerChatCommand('./custom/SubscriberLevels_0.1.1.js', 'setsubname', 1);
			$.registerChatCommand('./custom/SubscriberLevels_0.1.1.js', 'subnamechange', 2);


			$.consoleLn('** Resub-Level-Module by aKuhTV, v. 0.1.1_ger (C)2019 **');
        }
    });
